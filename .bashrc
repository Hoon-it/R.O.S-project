...
# bebop_Drone
#export ROS_HOSTNAME=192.168.42.46
#export ROS_MASTER_URI=http://192.168.42.46:11311
...
alias node='node gps2web/app.js'
alias tel='rosrun bb2_pkg bebop_teleop.py'
alias tel2='rosrun bb2_pkg bebop_teleop2.py'

alias vir='rosrun bb2_pkg bebop_map_web.py 1'
alias real='rosrun bb2_pkg bebop_gps2web.py 0'
...
alias gps='rostopic echo /bebop/states/ardrone3/PilotingState/PositionChanged'

alias bdr='roslaunch bebop_driver bebop_nodelet.launch'

alias b21='roslaunch bb2_pkg 21_fly_by_param.launch'
