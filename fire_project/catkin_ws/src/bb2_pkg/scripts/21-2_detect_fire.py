...
class DetectFire:
  ...
  def save_picture(self, picture):
    try:
      ...
      filename = '/home/hjh/fire_img/fire.png'.format(date, hour)
...
if __name__ == '__main__':
    ...
    try:
        #fire_cascade = cv2.CascadeClassifier('/home/hjh/catkin_ws/src/bb2_pkg/scripts/fire_detection.xml') 
        fire_cascade = cv2.CascadeClassifier('/home/hjh/catkin_ws/src/bb2_pkg/scripts/cascade025.xml')
